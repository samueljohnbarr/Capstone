/**
 * Displays the simulation and handles I/O
...
public class Window extends Application {
    ...
    private static Window keplerWindow = null;
    ...
    private Boolean showOrbitLine = false;
    private Group rings;
    private Group lines;
    ...
    private Group initLines(Group g) {
    	...
    	line.setEndY(screen.getHeight()/2);
    	line.setEndX(screen.getWidth());
    	line.setStroke(Color.YELLOW);
    	line.setVisible(showOrbitLine);
    	g.getChildren().add(line);
    ...
    public MenuBar setUpMenus() {
        ...
        Menu viewMenu = new Menu("View");
			...
			CheckMenuItem setOrbitalLineOnOff = new CheckMenuItem("Show Synodic Reference Line");
			setOrbitalLineOnOff.setOnAction(e -> {showOrbitLine =! showOrbitLine;refresh();update();});


        	viewMenu.getItems().addAll(setBackgroundOnOff,setPlanetTexturesOnOff,setHighlightsOnOff,showPlanetConnectionsCMI,setOrbitalLineOnOff);
...
/**
 * Creates the buttons that control the simulation
 * @return buttonLine
 */
...
/**
 * Creates the labels that display the dates
 * @return labels
 */
...
/**
* Creates the fields where day and date data is input
* @return inPanel
*/
...
/**
* Creates the scaler that controls the zoom function
* @return zoom
*/
    ...
    /**
     * Resets the sim to its initial state by reinitiating the fields, and resetting the date
     */
...
/**
 * Creates a popup window with the about information
 */

    public void aboutPage() {

        Image keplerAboutImage = new Image(Window.class.getResourceAsStream("kepler_about.png"));
        Stage dialog = new Stage();
        VBox placeHolder = new VBox();
        placeHolder.setVisible(false);
        Scene dialogScene = new Scene(placeHolder, 640, 420, new ImagePattern(keplerAboutImage));
        dialog.setTitle("About");
        dialog.getIcons().add(new Image(Window.class.getResourceAsStream("icon.png")));
...
/**
 * Creates a popup window with the help information
 */
